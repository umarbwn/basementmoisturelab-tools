...
import { Container, Row, Col, Card, ProgressBar, Form, Button, Badge, Alert, ListGroup, Nav } from 'react-bootstrap';
import {
    Ruler,
    Droplets,
    Home,
                            ...
                            <Card.Body className="pb-0">
                                <div className="mb-4">
                                    <Row className="align-items-center mb-2">
                                        <Col>
                                            <h6 className="fw-semibold mb-0">Your Progress</h6>
                                            <small className="text-muted">
                                                {completedCount === 6
                                                    ? "Ready to calculate! 🎉"
                                                    : `${6 - completedCount} steps remaining`}
                                            </small>
                                        </Col>
                                        <Col xs="auto" className="text-end">
                                            <span className="h3 text-primary fw-bold mb-0">{Math.round(progressPercentage)}%</span>
                                            <small className="text-muted d-block">complete</small>
                                        </Col>
                                    </Row>
                                    ...
                                    <Row className="g-2 text-center mt-3">
                                        {[
                                            ...
                                            <Col key={index} xs={2}>
                                                ...
                                                >
                                                    {completedSteps[index] ? '✓' : step.icon}
                                                </div>
                                                <small className={`d-block ${completedSteps[index] ? 'text-dark' : 'text-muted'}`}>
                                                    {step.name}
                                                </small>
                                            </Col>
                                        ))}
                                ...
                                <div className="mb-4 pb-3 border-bottom">
                                    ...
                                    <Form.Group className="mb-3">
                                        ...
                                        {inputs.sqFootage < 100 && (
                                            <Form.Text className="text-warning">Minimum recommended size is 100 sq ft</Form.Text>
                                        )}
                                    </Form.Group>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="border-top pt-3">
                                            ...
                                            <ListGroup variant="flush" className="small">
                                                ...
                                                <ListGroup.Item className="d-flex justify-content-between px-0 fw-semibold border-top">
                ...
                <Row className="mt-5 g-3">
                    <Col md={6} lg={4} xl>
                        <Card className="h-100 border-0 shadow-sm">
                            <Card.Body>
                                <Card.Title as="h6" className="fw-semibold">Volume vs Square Feet</Card.Title>
                                <Card.Text className="small text-muted">Why ceiling height matters</Card.Text>
                                <Card.Link href="/blog/basement-volume-vs-square-feet" className="stretched-link" />
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} lg={4} xl>
                        <Card className="h-100 border-0 shadow-sm">
                            <Card.Body>
                                <Card.Title as="h6" className="fw-semibold">Moisture Levels</Card.Title>
                                <Card.Text className="small text-muted">Diagnose your basement</Card.Text>
                                <Card.Link href="/blog/diagnosing-basement-moisture" className="stretched-link" />
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} lg={4} xl>
                        <Card className="h-100 border-0 shadow-sm">
                            <Card.Body>
                                <Card.Title as="h6" className="fw-semibold">Unfinished Spaces</Card.Title>
                                <Card.Text className="small text-muted">Special considerations</Card.Text>
                                <Card.Link href="/blog/unfinished-basement-dehumidifier" className="stretched-link" />
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} lg={4} xl>
                        <Card className="h-100 border-0 shadow-sm">
                            <Card.Body>
                                <Card.Title as="h6" className="fw-semibold">Foundation Cracks</Card.Title>
                                <Card.Text className="small text-muted">Sealing guide</Card.Text>
                                <Card.Link href="/blog/sealing-foundation-cracks" className="stretched-link" />
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md={6} lg={4} xl>
                        <Card className="h-100 border-0 shadow-sm">
                            <Card.Body>
                                <Card.Title as="h6" className="fw-semibold">Pump Guide</Card.Title>
                                <Card.Text className="small text-muted">Drainage options explained</Card.Text>
                                <Card.Link href="/blog/dehumidifier-pump-guide" className="stretched-link" />
                            </Card.Body>
                        </Card>
                    </Col>
                </Row>
